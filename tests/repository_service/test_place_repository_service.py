...
class TestPlaceRepositoryService(unittest.TestCase):
    ...
    def test_store_place_data(self):
        # Setup
        place = PlaceModel(name="Place 1", user_id=1, description="test description")
        expected_name = place.name
        # Actions
    ...
    def test_get_all_paces_and_switches_for_user(self):
        # Setup
        place = PlaceModel(name="Place 1", user_id=1, description="test description")
        place_two = PlaceModel(name="Place 2", user_id=1, description="test description")
        expected_name = place.name
